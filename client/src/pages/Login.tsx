  ...
  return (
    <div style={{ fontFamily: mono, background: "#1A1A1B", minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "40px 20px" }}>
      ...
      <div style={{ width: "100%", maxWidth: 400, position: "relative", zIndex: 1 }}>
        {/* Blueprint top line */}
        <div style={{ height: 1, background: "rgba(245,242,237,0.08)", marginBottom: 0 }} />
        ...
        <div style={{ border: "1px solid rgba(245,242,237,0.08)", borderTop: "none", padding: "40px 36px" }}>
          ...
          <h1 style={{ fontFamily: serif, fontSize: 28, fontWeight: 700, color: "#F5F2ED", marginBottom: 32, letterSpacing: "-0.5px", lineHeight: 1.1 }}>
            Welcome back.
          </h1>
          ...
          <div style={{ textAlign: "center", fontSize: 11, color: "rgba(245,242,237,0.3)", letterSpacing: "0.06em" }}>
            NO ACCOUNT?{" "}
            <a href="/signup" style={{ color: "#C05746", textDecoration: "none", fontWeight: 600 }}>START FREE →</a>
          </div>
        </div>
      </div>

      <p style={{ marginTop: 32, fontSize: 10, color: "rgba(245,242,237,0.2)", letterSpacing: "0.1em", position: "relative", zIndex: 1 }}>
